...
$timeSelect = new Quform_Element('time_select', 'Time select');
$timeSelect->addValidator('required');
$form->addElement($timeSelect);

$peopleSelect = new Quform_Element('people_select', 'People select');
$peopleSelect->addValidator('required');
$form->addElement($peopleSelect);


$personalPhone = new Quform_Element('personal_phone');
$personalPhone->addValidator('required');
$personalPhone->addFilter('digits');
$form->addElement($personalPhone);
/*
